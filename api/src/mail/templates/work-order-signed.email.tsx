...
export function WorkOrderSignedEmail({ lang, userName, vehicleName, licensePlate, workshopName, technicianName, description, signedAt }: Props) {
  const c = copy.workOrderSigned
  return (
    <Html lang={lang}>
      <Head />
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.card}>
            ...
            <Text style={styles.detail}><strong>{tr(c.signed, lang)}:</strong> {signedAt}</Text>
